                ...
                >
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 w-full max-w-6xl">
                        ...
                        <motion.div 
                            ...
                            className="p-5 sm:p-10 rounded-2xl sm:rounded-3xl bg-white/20 backdrop-blur-sm border border-white/10"
                        >
                            <h2 className="text-white text-xl sm:text-2xl font-semibold mb-6 sm:mb-8 tracking-tight">Send us a Message</h2>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                        className="w-full h-12 px-4 rounded-xl border border-gray-500 bg-white/5 text-white placeholder:text-white-500 focus:outline-none focus:ring-2 focus:ring-white/20 focus:border-transparent hover:bg-white/10 transition-colors duration-200"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <Select>
                                        <SelectTrigger
                                            ...
                                            open={selectOpen}
                                            className="border border-gray-500 bg-white/5 text-white rounded-md focus:border-gray-400 focus:ring-1 focus:ring-gray-400"
                                        />
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        required
                                        rows={5}
                                        className="w-full px-4 py-3 rounded-xl border border-gray-500 bg-white/5 text-white placeholder:text-white-500 focus:outline-none focus:ring-2 focus:ring-white/20 focus:border-transparent hover:bg-white/10 transition-colors duration-200 resize-none"
                                    />
                                </div>
                                ...
                                <button
                                    type="submit"
                                    className="cursor-pointer w-full h-12 px-8 text-lg font-medium text-white bg-[#0B1F3A]/55 rounded-xl hover:bg-[#FCA311]-300 transition-all duration-300"
                                >
                                    Send Message
                                </button>
                            </form>
                        ...
                        >
                            ...
                            <div className="space-y-4 sm:space-y-6">
                                {/* Location */}
                                <div className="flex items-start gap-3 sm:gap-4 p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-[#0B1F3A] backdrop-blur-sm border border-white/10">
                            ...
                            {/* Quick Links */}
                            <div className="p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-[#0B1F3A] backdrop-blur-sm border border-white/10">
