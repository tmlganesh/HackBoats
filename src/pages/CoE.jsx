        ...
        >
            ...
            <motion.section 
                ...
                >
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-semibold tracking-tight mb-6">What is a Centre of Excellence?</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full max-w-6xl">
                        {coeFeatures.map((feature, index) => (
                            <motion.div
                                ...
                                className="p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-500"
                            >
                ...
                >
                    <motion.div 
                        ...
                        className="text-center mb-16 max-w-3xl"
                    >
                        <h2 className="text-4xl md:text-5xl font-semibold tracking-tight mb-6">Benefits for Your Institution</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-5xl">
                        {benefits.map((benefit, index) => (
                            ...
                            >
                                <benefit.icon className="w-10 h-10 text-gray-400 mb-6 group-hover:text-white transition-colors duration-300" />
                ...
                >
                    <motion.div 
                        ...
                        className="text-center mb-16 max-w-3xl"
                    >
                        <h2 className="text-4xl md:text-5xl font-semibold tracking-tight mb-6">Industry-Academia Collaboration Model</h2>
                        <p className="text-xl text-gray-400">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
                        {Object.values(collaborationModel).map((model, index) => (
                            <motion.div
                                ...
                                className="group p-10 rounded-3xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-500"
                            >
                                <model.icon className="w-12 h-12 text-gray-400 mb-6 group-hover:text-white transition-colors duration-300" />
                                <h3 className="text-2xl font-semibold mb-6 tracking-tight">{model.title}</h3>
