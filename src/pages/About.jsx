        ...
        >
            ...
            <motion.section 
                ...
                <motion.section 
                    ...
                    className="flex flex-col justify-center items-center px-4 sm:px-6 py-16 sm:py-20"
                >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 w-full max-w-5xl">
                        <motion.div 
                            ...
                            className="p-6 sm:p-10 rounded-2xl sm:rounded-3xl bg-white/5 backdrop-blur-sm border border-white/10"
                        >
                            <h3 className="text-sm text-gray-400 tracking-wider uppercase mb-3 sm:mb-4">Our Vision</h3>
                        ...
                        <motion.div 
                            ...
                            className="p-6 sm:p-10 rounded-2xl sm:rounded-3xl bg-white/5 backdrop-blur-sm border border-white/10"
                        >
                            <h3 className="text-sm text-gray-400 tracking-wider uppercase mb-3 sm:mb-4">Our Mission</h3>
                            <p className="text-base sm:text-xl text-gray-300 leading-relaxed">
                ...
                >
                    ...
                    >
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold tracking-tight mb-4 sm:mb-6">Our Story</h2>
                    </motion.div>
                    ...
                    <motion.div 
                        ...
                        className="max-w-3xl space-y-4 sm:space-y-6 px-2"
                    >
                ...
                >
                    ...
                    >
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold tracking-tight mb-4 sm:mb-6">Our Core Values</h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 w-full max-w-5xl">
                        {coreValues.map((value, index) => (
                            ...
                            >
                                <value.icon className="w-8 h-8 sm:w-10 sm:h-10 text-gray-400 mb-4 sm:mb-6 group-hover:text-white transition-colors duration-300" />
                                <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 tracking-tight">{value.title}</h3>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 w-full max-w-5xl">
                        {ecosystem.map((item, index) => (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                transition={{ duration: 0.5, delay: index * 0.1 }}
                                className="group p-5 sm:p-8 rounded-xl sm:rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-500 text-center"
                            >
                                <item.icon className="w-10 h-10 sm:w-12 sm:h-12 text-gray-400 mb-4 sm:mb-6 mx-auto group-hover:text-white transition-colors duration-300" />
