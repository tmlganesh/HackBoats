            ...
            >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 w-full max-w-5xl">
                    <motion.div
                        ...
                        className="p-6 sm:p-10 rounded-2xl sm:rounded-3xl bg-[#0B1F3A] backdrop-blur-sm border border-white/10"
                    >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 w-full max-w-5xl">
                    {ecosystem.map((item, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            transition={{ duration: 0.5, delay: index * 0.1 }}
                            className="group p-5 sm:p-8 rounded-xl sm:rounded-2xl bg-[#0B1F3A] backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-500 text-center"
                        >
