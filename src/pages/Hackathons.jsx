                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 w-full max-w-4xl my-8 sm:my-12">
                        {hackMelaStats.map((stat, index) => (
                            <motion.div
                                ...
                                className="p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-[#0B1F3A] backdrop-blur-sm border border-white/10 text-center"
                            >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 w-full max-w-6xl">
                        {participants.map((item, index) => (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                transition={{ duration: 0.5, delay: index * 0.1 }}
                                className="group p-4 sm:p-8 rounded-xl sm:rounded-2xl bg-[#0B1F3A] backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-500 hover:-translate-y-1 text-center"
                            >
