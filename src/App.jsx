            ...
            >
                    ...
                    <motion.div variants={fadeInUp} className="flex flex-wrap justify-center gap-3 mb-12">
                        {techPills.map((tech, index) => (
                            <motion.span
                                ...
                                className="px-5 py-2 text-sm text-gray-400 border border-gray-800 rounded-full hover:text-white hover:border-gray-600 transition-all duration-500 cursor-pointer"
                            >
                                {tech}
                            </motion.span>
                        ))}
                ...
                >
                    <motion.div 
                        ...
                        transition={{ duration: 0.6 }}
                    >
                        <h2 className="text-4xl md:text-6xl font-semibold tracking-tight mb-6">Our Three Wings</h2>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full max-w-7xl">
                        {threeWings.map((wing, index) => (
                            <motion.div
                                ...
                                className="group p-10 rounded-3xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-700 hover:-translate-y-1"
                            >
                                <span className="inline-block text-sm text-gray-500 mb-6 tracking-wider">0{index + 1}</span>
                                <h3 className="text-2xl font-semibold mb-4 tracking-tight">
                                    {wing.title}
                                </h3>
                                <p className="text-gray-400 mb-8 leading-relaxed">{wing.description}</p>
                ...
                >
                    <motion.div 
                        ...
                        transition={{ duration: 0.6 }}
                    >
                        <h2 className="text-4xl md:text-6xl font-semibold tracking-tight mb-6">Industries We Serve</h2>
                        <p className="text-xl text-gray-400">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-5xl">
                        {industries.map((industry, index) => (
                            <motion.div
                                ...
                                className="group p-8 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/5 hover:bg-white/10 hover:border-white/10 transition-all duration-500 cursor-pointer"
                            >
                                <h3 className="text-xl font-semibold mb-3 tracking-tight">{industry.title}</h3>
                ...
                <motion.section 
                    id="contact" 
                    className="min-h-[80vh] flex flex-col justify-center items-center px-6 py-20"
                    initial={{ opacity: 0 }}
                    whileInView={{ opacity: 1 }}
                    viewport={{ once: true, margin: "-100px" }}
                    transition={{ duration: 0.6 }}
                >
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <a
                                href="#contact"
                                className="inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-black bg-cyan-500 rounded-full hover:bg-cyan-400 transition-colors duration-300"
                            >
