...
const techPills = ['Robotics', 'AI', 'IoT', 'Drones', 'Animatronics', 'Space Science']
                ...
                <motion.div variants={fadeInUp} className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-8 sm:mb-12 px-2">
                    {techPills.map((tech, index) => (
                        <motion.span
                            ...
                            className="px-3 sm:px-5 py-1.5 sm:py-2 text-xs sm:text-sm text-white/400 border border-white/20 rounded-full hover:text-white hover:bg-white/10 border-white/40 transition-all duration-300 cursor-pointer"
                        >
                            {tech}
                        </motion.span>
                    ))}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8 w-full max-w-7xl">
                    {threeWings.map((wing, index) => (
                        <motion.div
                            ...
                            className="group p-6 sm:p-10 rounded-2xl sm:rounded-3xl bg-[#0B1F3A] backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-700 hover:-translate-y-1"
                        >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 w-full max-w-5xl">
                    {industries.map((industry, index) => (
                        <motion.div
                            ...
                            className="group p-5 sm:p-8 rounded-xl sm:rounded-2xl bg-[#0B1F3A] backdrop-blur-sm border border-white/5 hover:bg-white/10 hover:border-white/10 transition-all duration-500 cursor-pointer"
                        >
